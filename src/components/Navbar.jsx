...
//             <nav className='z-10 flex justify-around mt-3 items-center'>
//                 <div className="logo text-[23px] text-red-700 font-bold tracking-wide uppercase flex items-center">
//                     <span className="text-4xl font-extrabold">ZEE</span>
//                     <span className="ml-1 text-2xl">Movie</span>
//                 </div>
//                 <div className='flex gap-7 items-center z-10'>
//                     <NavLink to='/'><li className='list-none text-xl hover:text-red-700'>Home</li></NavLink>
//                     <NavLink to='/Movie'><li className='list-none text-xl hover:text-red-700'>Movies</li></NavLink>
//                     <NavLink to='/upcoming'><li className='list-none text-xl hover:text-red-700'>UpComing</li></NavLink>
//                     <NavLink to='/toprated'><li className='list-none text-xl hover:text-red-700'>Top-Rated</li></NavLink>
//                 </div>
//                 <div className="search flex items-center gap-3">
             
//                     <NavLink to='/register'>
//                         <button className='flex items-center bg-red-700 text-sm font-semibold px-4 py-2 rounded-md hover:bg-red-800 transition duration-300'>
